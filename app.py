...
FAQ = [
    ...
    {
        "q": "前回選んだ観測地点は引き継がれますか？",
        "a": "観測地点・基準温度・気温補正の3つは、次に開いたときも入力済みの状態になります。"
             "毎回同じ地点で使うことが多いためです。開始日と終了日は、古い日付が残っていると"
             "紛らわしいので引き継ぎません。覚えておく先はお使いの端末のブラウザの中だけで、"
             "サーバーには送っていません。そのため別の端末やブラウザでは引き継がれず、"
             "プライベートモードで開いた場合や、ブラウザのサイトデータを削除した場合も消えます。",
    },
    {
        "q": "天気や降水量はどこまで表示されますか？",
        "a": "過去の日は観測値、今日から7日先までは気象庁の予報を表示し、それ以降は空欄です。"
             "降水量(mm)の予報は提供されていないため、未来の日は代わりに降水確率(%)を"
             "別の列に出しています。いずれも積算温度の計算には使っていません。",
    },
    {
        "q": "過去の天気が空欄になる地点があるのはなぜですか？",
        "a": "天気(晴・曇・雨など)を観測しているのは、掲載している約930地点のうち"
             "気象台や測候所などの官署およそ160地点だけです。残りのアメダスは気温や降水量は"
             "測っていても天気は観測していないため、過去の日の天気は空欄になります。"
             "降水量は多くのアメダスで観測しているので表示されます。"
             "なお未来の日の天気は、その地点が属する地域の週間予報を使うので、"
             "アメダスを選んだ場合でも表示されます。",
    },
    {
